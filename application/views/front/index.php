				...
				<div class="col-lg-12">
					...
					<div class="slider-container">
						<div class="swiper-container image-slider-2">
							<div class="swiper-wrapper">
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-1.png" alt="alternative">
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-2.png" alt="alternative">
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-3.png" alt="alternative">
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-4.png" alt="alternative">
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-5.png" alt="alternative">
								</div>
								<div class="swiper-slide">
									<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/customer-logo-6.png" alt="alternative">
								</div>
							</div>
							<!-- end of swiper-wrapper -->
						</div>
	...
	<div class="basic-3">
		<div class="container">
			<div class="row">
				...
				<!-- end of col -->
				<div class="col-lg-6">
					<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/students.jpg" alt="alternative">
				</div>
				<!-- end of col -->
			</div>
			<!-- end of row -->
			...
			<div class="row">
				...
				<div class="col-lg-8">
					<div class="image-container">
						<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/details-lightbox.jpg" alt="alternative">
					</div>
					...
					<div class="image-container">
						<div class="video-wrapper">
							<a class="popup-youtube" href="https://www.youtube.com/watch?v=fLCjQJCekTs" data-effect="fadeIn">
								<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/video.jpg" alt="alternative">
							...
							<div class="swiper-wrapper">
								...
								<div class="swiper-slide">
									<div class="image-wrapper">
										<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/testimonial-1.jpg" alt="alternative">
									</div>
								...
								<div class="swiper-slide">
									<div class="image-wrapper">
										<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/testimonial-2.jpg" alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
								...
								<div class="swiper-slide">
									<div class="image-wrapper">
										<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/testimonial-3.jpg" alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
								...
								<div class="swiper-slide">
									<div class="image-wrapper">
										<img class="img-fluid" src="<?php echo base_url("assets/front-landing/")?>images/testimonial-4.jpg" alt="alternative">
									</div>
									<!-- end of image-wrapper -->
									<div class="text-wrapper">
			...
			<div class="row">
				<div class="col-lg-12">
					<div class="text-container">
						...
						<p>Our mission is to help people do better SEO. The team is excited to invite you to the next SEO Training Course session which undoubtedly will provide you with the necessary skills to improve your online presence. Fill out the form
							to register and we'll contact you in less than 24h</p>
						<a class="btn-solid-lg page-scroll" href="#register">REGISTER</a>
					</div>
					<!-- end of text-container -->
				</div>
