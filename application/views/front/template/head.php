<head>
	...
	<meta name="author" content="Armando Graterol">

	<!-- OG Meta Tags to improve the way the post looks when you share the page on LinkedIn, Facebook, Google+ -->
	<meta property="og:site_name" content="Avimark Studio" />
	<!-- website name -->
	<meta property="og:site" content="Avimark Studio" />
	<!-- website link -->
