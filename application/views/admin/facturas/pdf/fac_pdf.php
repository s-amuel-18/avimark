        ...
        <tbody>
          ...
          <tr>
            ...
            <td class="w-50">
              ...
              <p class="m-0 text-right"><strong>DATA</strong>: <?php echo $factura->nombre_cliente ?></p>
      ...
      <table class="text-capitalize table table-striped">
        ...
        <tfoot>
          ...
          <tr>
            ...
            <th class="bg-gray-light">$<?php echo number_format($servicios_total->total_pago + $impuesto, 2) ?></th>
          </tr>
        </tfoot>
      </table>
    </div>
