												...
												<tr data-id="<?php echo $servicio->categoria_id ?>" class="alert fade show" id="categoria_select_<?php echo $servicio->categoria_id ?>">
													...
													<td>
														<div class="input-group m-0">
															...
															<input disabled id="total_precio_<?php echo $servicio->categoria_id ?>" value="<?php echo $servicio->precio * $servicio->cantidad  ?>" placeholder="$...." class="form-control precio_total_servicio" style="background: #4d4d4d;" type="number" min="0">
														</div>
												...
												<tr >
													...
													<td>
														<div class="input-group m-0">
															...
															<input disabled  value="<?php echo $servicio["precio"] ?>" placeholder="$...." class="form-control precio_total_servicio" style="background: #4d4d4d;" type="number" min="0">
														</div>
