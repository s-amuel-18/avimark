<head>
	...
	<title>Avimark Studio | Admin</title>
	...
	<!-- preview -->
	<link rel="stylesheet" href="<?php echo base_url() ?>assets/css/previw_image.css">
	...
	<style>
		...
		.input_transparent_update:focus {
			/* background: #000; */
